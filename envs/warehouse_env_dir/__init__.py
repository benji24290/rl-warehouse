...
if __name__ == '__main__':
    ...
    if(compare_policies):
        ...
        q_env_exp_2 = WarehouseEnv(config)
        results_q_learning_policy_exp_2 = run_policy_test_agent(
            env=q_env_exp_2, num_episodes=1000, Q=q_env_exp_2.rewards.import_q("experiment-2-q-learning.csv"), random_seed=random_seed)
        sarsa_env_exp_2 = WarehouseEnv(config)
        results_sarsa_policy_exp_2 = run_policy_test_agent(
            env=sarsa_env_exp_2, num_episodes=1000, Q=sarsa_env_exp_2.rewards.import_q("experiment-2-sarsa.csv"), random_seed=random_seed)
        ...
        results_q_learning_policy.plot_episode_rewards(
            label='Q-Learning Versuch 3',  std=False)
        results_sarsa_policy.plot_episode_rewards(
            label='Sarsa Versuch 3',  std=False)
        results_q_learning_policy_exp_2.plot_episode_rewards(
            label='Q-Learning Versuch 2',  std=False)
        results_sarsa_policy_exp_2.plot_episode_rewards(
            label='Sarsa Versuch 2',  std=False)
